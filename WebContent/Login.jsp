	...
	<h:form>
		...
		<h:panelGrid border="1" columns="2">
			...
			<h:inputText value="#{loginMB.userName}" required="true"
				requiredMessage="Please enter User Name"></h:inputText>
		...
		<h:commandButton type="submit" value="Login"
			action="#{loginMB.validatePassword}" style="width: 92px"></h:commandButton>
		<h:commandButton value="Reset" type="reset" style="width: 92px"></h:commandButton>
		<br>

		<h:outputLabel value="#{loginMB.message}"></h:outputLabel> <br>

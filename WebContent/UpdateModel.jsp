	...
	<h:form>
		...
		<h:panelGrid border="1" columns="3">
			...
			<h:selectOneMenu id="selectmodel"
				valueChangeListener="#{updateModelMB.getModel}"
				onchange="fnSubmit()" required="true"
				requiredMessage="Select Particular model please!!!!">
				<f:selectItem itemLabel="select" />
				<f:selectItems value="#{updateModelMB.modelIdList}" />
			</h:selectOneMenu>
			<h:message for="selectmodel"></h:message>
			<h:outputText value="Model Name:"></h:outputText>
			<h:inputText value="#{updateModelMB.modelTO.modelName}"
				disabled="true"></h:inputText>
			<h:outputText value=""></h:outputText>
			<h:outputText value="Variant:"></h:outputText>
			<h:inputText value="#{updateModelMB.modelTO.variant}" disabled="true"></h:inputText>
			<h:outputText value=""></h:outputText>
			<h:outputText value="Fuel Type:"></h:outputText>
			<h:inputText value="#{updateModelMB.modelTO.fuelType}"
				disabled="true"></h:inputText>
			<h:outputText value=""></h:outputText>
			<h:outputText value="Cubic Capacity:"></h:outputText>
			<h:inputText value="#{updateModelMB.modelTO.cubicCapacity}"
				disabled="true"></h:inputText>
			<h:outputText value=""></h:outputText>
			<h:outputText value="Enter Price:"></h:outputText>
			<h:inputText id="modelprice" value="#{updateModelMB.price}"
				required="true" requiredMessage="Enter Price"></h:inputText>
			<h:message for="modelprice"></h:message>
		</h:panelGrid> <h:commandButton action="#{updateModelMB.updateModel}" type="submit"
			value="Update">
		</h:commandButton> <h:commandButton type="reset" value="Reset">

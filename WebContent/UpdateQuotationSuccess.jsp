		...
		<center><c:choose>
			<c:when test="${role=='E'}">
				...
				<h:panelGrid border="1" columns="2">
					...
					<h:outputText
						value="#{updateQuotationMB.enquiryQuotationTO.quotaionTO.quotationId}"></h:outputText>
					<h:outputText value="Customer Name"></h:outputText>
					<h:outputText
						value="#{updateQuotationMB.enquiryQuotationTO.prospectiveCustomerTO.customerName}"></h:outputText>
					<h:outputText value="Model Name"></h:outputText>
					<h:outputText
						value="#{updateQuotationMB.enquiryQuotationTO.modelTO.modelName}"></h:outputText>
					<h:outputText value="Actual Price"></h:outputText>
					<h:outputText
						value="#{updateQuotationMB.enquiryQuotationTO.modelTO.price}"></h:outputText>
					<h:outputText value="Quoted Price"></h:outputText>
					<h:outputText
						value="#{updateQuotationMB.enquiryQuotationTO.quotaionTO.quotedPrice}"></h:outputText>
				</h:panelGrid>
				<br>
				<br>
				...
				<br>
				<h:commandButton value="Send Quotation" type="submit"
					action="#{updateQuotationMB.sendQuotation}"></h:commandButton>
				<br>
				<br>

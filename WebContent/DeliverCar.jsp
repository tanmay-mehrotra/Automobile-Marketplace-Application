	...
	<h:form>
		...
		<center><c:choose>
			<c:when test="${role=='D'}">
				...
				<h:dataTable border="1" var="deliver"
					value="#{carDeliverMB.listOfCars}">
					<h:column id="regNo">
						<f:facet name="header">
							<h:outputText value="Registration Number"></h:outputText>
						</f:facet>
						<h:outputText value="#{deliver.registrationNo}"></h:outputText>
					</h:column>
					<h:column id="chassisNo">
						<f:facet name="header">
							<h:outputText value="Chassis Number"></h:outputText>
						</f:facet>
						<h:outputText value="#{deliver.chassisNo}"></h:outputText>
					</h:column>
					<h:column id="modelid">
						<f:facet name="header">
							<h:outputText value="Model Id"></h:outputText>
						</f:facet>
						<h:outputText value="#{deliver.modelId}"></h:outputText>
					</h:column>
					<h:column id="custId">
						<f:facet name="header">
							<h:outputText value="Custumer Id"></h:outputText>
						</f:facet>
						<h:outputText value="#{deliver.custId}"></h:outputText>
					</h:column>
					...
					<h:column id="color">
						...
						<h:outputText value="#{deliver.colorId}"></h:outputText>
					</h:column>
				</h:dataTable>
				<br />
				<br />
				...
				<h:outputLabel value="Registration Number "></h:outputLabel>
				<h:selectOneMenu value="#{carDeliverMB.chassisNumber}"
					required="true" requiredMessage="Please Select Chassis Number!">
					<f:selectItem itemLabel="select" />
					<f:selectItems value="#{carDeliverMB.chassisNoList}" />
				</h:selectOneMenu>
				<br>
				<br>
				<h:commandButton value="Deliver" type="submit"
					action="#{carDeliverMB.deliverCar}"
					style="width: 116px; height: 32px">
				</h:commandButton>
				<br>
				<h:messages></h:messages>
				<br>
				<h:outputLabel value="#{carDeliverMB.message}"></h:outputLabel>
			</c:when>
			<c:otherwise>
				<center><br>
				<br>

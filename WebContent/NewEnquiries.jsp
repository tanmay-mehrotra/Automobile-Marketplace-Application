...
<f:view>
	...
	<center><h:form>
		<c:choose>
			<c:when test="${role=='E'}">
				<H2 style="color: #666666">New Jobs Assigned</H2>

				<h:dataTable border="1" style="color:#666666"
					value="#{newJobsMB.enquiryList}" var="row">
					<h:column id="requestId">
						<f:facet name="header">
							<h:outputText value="Request Id"></h:outputText>
						</f:facet>
						<h:outputText value="#{row.requestId}"></h:outputText>
					</h:column>

					<h:column id="pCustomerId">
						<f:facet name="header">
							<h:outputText value="Prospective CustomerId"></h:outputText>
						</f:facet>
						<h:outputText value="#{row.prospectiveCustomerId}"></h:outputText>
					</h:column>
					<h:column id="modelId">
						<f:facet name="header">
							<h:outputText value="Model Id"></h:outputText>
						</f:facet>
						<h:outputText value="#{row.modelId}"></h:outputText>
					</h:column>

					<h:column id="requestDate">
						<f:facet name="header">
							<h:outputText value="Date Of Request"></h:outputText>
						</f:facet>
						<h:outputText value="#{row.dateOfRequest}">
				...
				<h:selectOneMenu id="requestId" value="#{newJobsMB.requestId}"
					style="color: #666666" required="true"
					requiredMessage="Select RequestId">
					<f:selectItem itemLabel="Select" />
					<f:selectItems value="#{newJobsMB.requestIdList}" />
				</h:selectOneMenu>
				<h:message for="requestId"></h:message>
				<br>
				<br>
				<h:commandButton type="submit"
					action="#{newJobsMB.getEnquiryDetails}" value="Get Enquiry Details"></h:commandButton>
				<br>

...
<f:view>
	<h:form>
		...
		<h1>Are you Sure You Want to LogOut?<br>
		<h:commandLink>

		</h:commandLink><h:commandLink>

		</h:commandLink><h:panelGrid border="1" columns="2">
			<h:commandLink action="#{loginMB.logout}">
				<h:outputText value="Yes Sure"></h:outputText>
			</h:commandLink>
			<h:outputLink value="Home.jsp"> Not Now</h:outputLink>
